...
int main(int argc, char **argv)
{
    ...
    // Allocate buffers
    auto bo_in_activation = xrt::bo(device, sizeof(data_ap_fixed_t) * in_activation_size, fc1_bwd_krnl.group_id(0));
    auto bo_grads = xrt::bo(device, sizeof(data_ap_fixed_t) * grads_size, fc1_bwd_krnl.group_id(1));
    auto bo_in_weight = xrt::bo(device, sizeof(data_ap_fixed_t) * in_weight_size, fc1_bwd_krnl.group_id(2));
    auto bo_dX = xrt::bo(device, sizeof(data_ap_fixed_t) * dX_size, fc1_bwd_krnl.group_id(3));
    auto bo_dW = xrt::bo(device, sizeof(data_ap_fixed_t) * dW_size, fc1_bwd_krnl.group_id(4));
    auto bo_dB = xrt::bo(device, sizeof(data_ap_fixed_t) * dB_size, fc1_bwd_krnl.group_id(5));
