...
int main(int argc, char **argv)
{
    ...
    // Create kernels
    auto fc3_bwd_krnl = xrt::kernel(device, uuid, "fc3_bwd");
    ...
    auto run = fc3_bwd_krnl(bo_in_activation, bo_grads, bo_in_weight, bo_dX, bo_dW, bo_dB);
