...
extern "C" {
    void avg_pool1(
        ...
        #pragma HLS INTERFACE m_axi port=in_data bundle=gmem0 depth=6*24*24
        #pragma HLS INTERFACE m_axi port=out_data bundle=gmem1 depth=6*(24/2)*(24/2)

        avg_pool<2, 2, 6, 24, 24>(in_data, out_data);
    }
    ...
    //     static data_ap_fixed_t plane[24][24]; // scratch pad
